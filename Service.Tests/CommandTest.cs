...
{
    [Testable]
    public class CommandTest : TestCommand<TOutDTO, TModel, TID>
    {
        protected override ICommandContract<TOutDTO, TModel, TID> CreateService()
        {
            return new CommandService<TOutDTO, TModel, TID, TOutDTO, ModelContext>(new ModelContext());
        }
    }
}
//-:cnd:noEmit
